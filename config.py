...
BOT_NAME = getenv("BOT_NAME", "K556666 Music")
...
BOT_USERNAME = getenv("BOT_USERNAME", "K556666musicbot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "K556666assistant")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "K556666SupportGroup")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "Namechannel")
